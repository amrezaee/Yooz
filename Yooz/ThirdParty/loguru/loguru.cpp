	...
	#pragma warning(push)
	#pragma warning(disable : 4365)  // conversion from 'X' to 'Y', signed/unsigned
	                                 // mismatch
#endif
...
// TODO: use defined(_POSIX_VERSION) for some of these things?
		...
		#ifdef __linux__
		    /* On Linux, the default thread name is the same as the name of the
		       binary. Additionally, all new threads inherit the name of the thread
		       it got forked from. For this reason, Loguru use the pthread Thread
		       Local Storage for storing thread names on Linux. */
...
// ----------------------------------------------------------------------------
// 888888 88""Yb 88""Yb  dP"Yb  88""Yb      dP""b8  dP"Yb  88b 88 888888 888888 Yb dP
// 888888 88__   88__dP 88__dP dP   Yb 88__dP     dP   `" dP   Yb 88Yb88   88   88__
// YbdP    88 88""   88"Yb  88"Yb  Yb   dP 88"Yb      Yb      Yb   dP 88 Y88   88
// 88""    dPYb    88 888888 88  Yb 88  Yb  YbodP  88  Yb      YboodP  YbodP  88  Y8
// 88   888888 dP  Yb   88
// ----------------------------------------------------------------------------
